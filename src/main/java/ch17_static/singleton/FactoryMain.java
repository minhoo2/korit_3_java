...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        SmartPhone smartPhone1 = factory1.prodyceSmartPhone();
        // 이상의 코드에서 .produceSmartPhone()의 리턴 타입이 SmartPhone의 객체였습니다.
        System.out.println(smartPhone1);
        SmartPhone smartPhone2 = factory1.prodyceSmartPhone();
        System.out.println(smartPhone2);
        SmartPhone smartPhone3 = factory3.prodyceSmartPhone();
        SmartPhone smartPhone4 = factory4.prodyceSmartPhone();
