...
/*
    ...
    3. Seete / Getter 메서드 정의 -> alt + ins 사용할 수 있습니다.
        각각 필드에 대한 setter / getter 를 생성합니다.
        setter가 세개 / getter 세 개
        1) setGrade의 범위 1~4학년
        2) setScore의 범위 0.0 ~ 4.5 까지
        범위를 벗어나면 불가능한 입력입니다 가 출력되도록 작성하시오.

    4. UnivStudentMain 생성하시고
        student01 -> 기본 생성자 김일 / 1 / 3.3
        student02 -> 기본 생성자 김이 / 3 / -30 - > 실패하고 4.0
        student04 -> 기본 생성자 김삼 / 5 / -> 실패하고 2 / 2.7
        student05 -> 기본 생성자 김사 / 4 / 3.8
        student05 -> 기본 생성자 김오 / 2 / 1.0
