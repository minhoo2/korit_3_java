...
public class JSON2 {
    public static void main(String[] args) {
        ...
        userJson = gsonBUilder.toJson(user1);   // Json 데이터가 String인게 중요합니다
        System.out.println(userJson);

        // 2. JsonObject -> json으로의 변환 사례
        // JsonObject를 활용하여 studentConde 2025001 / studentName 김이 / studentYear 2 / score 96.7인 객체를 생성하시오
        // 참고로 key value 다 String으로 잡아놓겠습니다.

        // 그거 끝나면 gsonBuilder를 활용하여 JsonObject 객체를 json으로 변환시키오.
        // 그거 끝나면 해당 데이터를 studentJson에 대입하고, 출력하시오.
        ...
        /*
            ...
            productName 삼성 갤럭북 프로5
            라는 Entry(key-value pair)를 입력하시오.

            gsonBuiler를 활용하여 json으로 바꾸고 productJson에 대입하시오.
