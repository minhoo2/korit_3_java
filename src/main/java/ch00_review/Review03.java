...
//            } else {  // height < 110
//                System.out.println("하지만 키가 딸려서 못탑니다."); // 실행문 2-b
//            }
...
//        if(height >= 110) {
//            System.out.println("규정 키 제한 이상입니다."); // 실행문 1-1
//            if (age >= 7) {
//                System.out.println("롤러코스터 입장이 가능합니다."); // 실행문 1-a
//            } else {
//                System.out.println("하지만 나이가 딸려서 못탑니다."); // 실행문 2-b
//            }
//            System.out.println("감사합니다.");
//        } else {
//            System.out.println("규정 키 제한으로 탑승이 불가능합니다.");
//        }
