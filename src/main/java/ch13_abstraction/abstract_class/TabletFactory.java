...
/*
    지시사항
    1. Facttory클래스를 상속 받을 것
    2 그렇게 되면 시뻘건ㄴ 것들 뜨는데(두 번 뜰겁니다), 그 오류들을 처리할 것.
        1) implements methods... PhoneFacttory를 참조하여 sout을 작성할 것
        2) Factory 객체 생성 방식에 맞는  생성자  만들라고  하는건 딸깍딸깍하시ㅣ면 됩니다.
    ...
    4. Main.java로  이동해서
        tebletFactory1 객체를 생성하고, 애플 태블릿 공장이라고  이름 붙일 것.
